        ...
        <div className="flex flex-row w-full h-full overflow-hidden">
          <div className="flex-1 flex-col">
              ...
              <div className="flex grow items-center">
                ...
                <div className="flex px-10 text-sm justify-center rounded-sm">
                  <SettingsOption
                    ...
                    setFunction={(p) => {setPassFilter(p); setRefresh(!refresh);}}
                ...
                <button
                  type="button"
                  className={`flex mr-[1rem] p-0.5 w-24 text-sm justify-center rounded-full border-1 border-slate-500 hover:bg-slate-200 ${view3D ? 'bg-slate-200' : 'bg-slate-100'}`}
            ...
            <div className="flex-1">
              <div id="toSave" className="w-fit">
                <NodeView setData={setData} />
              </div>
              <div className="absolute top-14 left-10 opacity-75 max-h-full h-fit w-72 rounded-md justify-self-end items-start p-2 z-60 bg-white overflow-scroll text-sm">
