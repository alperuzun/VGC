    ...
    <div className="flex flex-col w-full h-full overflow-x-clip ">
      {/* <div className="flex bg-slate-50 border-1 border-slate-300 w-full rounded-lg">
        <div className="w-full h-min">
          ...
          {currDataObj != undefined ? currDataObj.title : "Enter your query above. "}
          </div>
        </div>
      </div> */}
...
//             <div className={`${settingsVisible ? "" : "hidden"} fixed w-72 h-full right-0 items-center shadow-lg p-2 bottom-[0px] bg-white`}>
//               <div className="flex w-full bg-[#3f89c7] ">
//                 <button className="flex items-center text-white hover:text-slate-200 hover:bg-[#278188] rounded-full p-1 z-50" onClick={() => setSettingsVisible(!settingsVisible)}>
//                   <AiOutlineClose />
//                 </button>
